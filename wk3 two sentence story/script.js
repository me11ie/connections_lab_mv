...
hover_morning.addEventListener("mouseover", ()=>{
    ...
    document.getElementById('title_card_1').html = "Until one day i realized"
}
);
...
/// Effect///
//identify hover
hover_2nd = document.getElementById('title_card_2');
...
///Afternoon Effect///
//identify hover
hover_cat = document.getElementById('title_card_3');

//identify image to impact
placesImg3 = document.getElementById('image_3');

//listen for hover
hover_cat.addEventListener("mouseover", () => {
    placesImg3.style.opacity = 1;
}
);

hover_cat.addEventListener("mouseout", () => {
